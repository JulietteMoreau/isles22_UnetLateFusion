...
docker volume create unetlatefusion_cl-output-$VOLUME_SUFFIX
...
docker run --rm \
        ...
        -v unetlatefusion_cl-output-$VOLUME_SUFFIX:/output/ \
        unetlatefusion_cl
...
docker volume rm unetlatefusion_cl-output-$VOLUME_SUFFIX
